...
*Result:*
```
  Tokenization Engine - ERC-3643 Deployment & Compliance Tests
Deploying implementation contracts...
    Token deployment and transfers tests
[Deployer] Deploying Token suite with TREXFactory. Name: Test Compliance Token, Symbol: TCT
[Deployer] Attempt 1 to execute transaction...
[Deployer] Transaction submitted: 0x3b22... Waiting for confirmations...
[Deployer] Transaction confirmed in block 16
[Deployer] Tokenization Suite deployed:
 - Token: 0x587C609DFf2E0210cC02E62581CE461e7fAF3D50
 - Identity Registry: 0x860C79d993888009083443C0E503aB8B3318E684
 - Modular Compliance: 0x59260070D2F59f248d17eED806198856a09206eA
      ✔ should successfully deploy an ERC-3643 token via the DeployerService (148ms)
      ✔ should prevent minting to an address without a verified identity
      ✔ should allow minting once identity is verified, but prevent transfer if recipient is not verified (44ms)
Transfer from Alice to Bob succeeded!
      ✔ should allow transfer once recipient identity is also verified
